...
~~~
Error in geom_sf(data = country_boundary_US, size = 2, color = "gray18"): object 'country_boundary_US' not found
~~~
{: .error}
...
~~~
Error in st_crs(country_boundary_US): object 'country_boundary_US' not found
~~~
{: .error}
